...
while True:
    ...
    required = num_check("How much do you need? ", "Yeah nah, you need to put a number in.", float)
    print()
    bought = num_check("How much did you buy?: ", "Yeah nah, you need to put a number in.", float)
    print()
